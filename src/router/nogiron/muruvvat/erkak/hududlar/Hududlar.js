    ...
    <div>
        ...
        <div className='soha'>
            ...
            <table className='table onlinee'>
                    <tr>
                    <Link className='link tooo' to={'/nogiron/erkak'}>
                        <td className='one_td online'>Erkaklar uchun</td>
                    </Link>
                    </tr>
                    
                    <tr>
                        <th className='two_th'>Farg‘ona “Qo‘qon” muruvvat uyi</th>
                            <div className='table_hr'></div>
                            <td className='two_td'>1 ta</td>
                            <div className='table_hr'></div>
                            <td className='two_td'>0 ta</td>
                        </tr>

                        <tr>
                        <li className='three_th'>Nogironlik guruhi 
                        og‘irlashtirilmaganlar</li>
                            <div className='table_hr'></div>
                        ...
                        <tr>
                        <li className='three_th'>Yig‘majildda RYTD yo‘qlar</li>
                            <div className='table_hr'></div>
                            <td className='three_td'>1 ta</td>
                            <div className='table_hr'></div>
                            <td className='three_td'>8 ta</td>
                        ...
                        <tr>
                        <li className='three_th'>RTV bilan ta’minlanmagan</li>
                            <div className='table_hr'></div>
                            <td className='three_td'>1 ta</td>
                            <div className='table_hr'></div>
                            <td className='three_td'>8 ta</td>
