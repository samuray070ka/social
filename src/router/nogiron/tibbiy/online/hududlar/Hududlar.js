        ...
        <div className='soha'>
            ...
            <div className='big_box'>
                <table className='table onlinee'>
                    <tr>
                    <Link className='link tooo' to={'/nogiron/online'}>
                    ...
                    <tr>
                        <th className='two_th'>Respublika bo‘yicha</th>
                        <div className='table_hr'></div>
                        <td className='two_td'>18 771 ta</td>
                        <div className='table_hr'></div>
                        <td className='two_td'>17 520 ta</td>
                    </tr>
                    <tr>
                    <Link className='link  tooo' to={'/nogiron/offline/hududlar'}>
