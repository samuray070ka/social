...
const toggleDropdownSeven = () => {
  ...
  return (
    <div>
         ...
         <div className="zaif  pink-mode pink-trans ws">
      ...
      <img className=' banner_img' src={homeImgOne} alt="" />
                ...
                {/* {
                  ...
                  {isDropdownVisible && (
                <div className='faoliyat_ro faoliyat_back pink-mode'>
              ...
              <Link to={'/ijtimoiy/ish-orni'} className='link'>
                ...
                {DropdownVisible && (
                <div className='faoliyat_ro faoliyat_back qu pink-mode'>
                <ul className='banner_collaction'>
              ...
              <Link to={'/faoliyat/korupsiya'} className='link'>
                ...
                {three && (
                <div className='faoliyat_ro faoliyat_back xa pink-mode'>
                <ul className='banner_collaction'>
              ...
              <Link to={'/normativ/idoraviy'} className='link'>
                ...
                {four && (
                <div className='faoliyat_ro faoliyat_back ya pink-mode'>
                <ul className='banner_collaction'>
              ...
              <Link to={'/jamoatchilik/elonlar'} className='link'>
                <li className='banner_item faoliyat_roo'>E’lonlar</li>
                  ...
                  {five && (
                <div className='faoliyat_ro faoliyat_back te pink-mode'>
                <ul className='banner_collaction'>
                {/* <Link to={'/jamoatchilik'} className='link'> */}
              ...
              {/* </Link> */}
                ...
                {six && (
                <div className='faoliyat_ro faoliyat_back da pink-mode'>
                <ul className='banner_collaction'>
                {/* <Link to={'/jamoatchilik'} className='link'> */}
              ...
              {/* </Link> */}
                  ...
                  {seven && (
                <div className='faoliyat_ro faoliyat_back onn pink-mode'>
                <ul className='banner_collaction'>
      ...
      <div className="banner_three pink-mode-old">
          ...
          <div className='three_flex '>
            <Link to={'/qulay-muhit'} className='link'>
                <div className='flex_box pink-mode'>
                  <div className='circle pink-mode cirle'>
