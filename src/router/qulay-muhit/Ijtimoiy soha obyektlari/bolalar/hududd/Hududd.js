        ...
        <div className='soha'>
            ...
            <div className='big_box'>
                <table className='table'>
                    ...
                    <tr>
                    <Link className='link tooo' to={'/qulay-muhit/bolalar'}>
                        <th className='one_th'>208 ta</th>
                        <div className='table_hr'></div>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/bolalar/hududd/farg'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/bolalar/hududd/sama'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/bolalar/hududd/qashq'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/bolalar/hududd/toshVil'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/bolalar/hududd/toshSh'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/bolalar/hududd/qora'}>
