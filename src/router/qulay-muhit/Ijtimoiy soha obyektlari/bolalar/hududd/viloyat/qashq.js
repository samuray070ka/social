        ...
        <div className='soha'>
            ...
            <div className='big_box'>
                <table className='table'>
                    ...
                    <tr>
                    <Link className='link tooo too' to={'/qulay-muhit/bolalar/hududd/farg'}>
                    ...
                    <tr>
                    <Link className='link tooo too' to={'/qulay-muhit/bolalar/hududd/sama'}>
                    ...
                    <tr>
                    <Link className='link tooo too' to={'/qulay-muhit/bolalar/hududd'}>
                    ...
                    <tr>
                        <li className='three_th'>Qashqadaryo shahri</li>
                        <div className='table_hr'></div>
                    ...
                    <tr>
                    <Link className='link tooo too' to={'/qulay-muhit/bolalar/hududd/toshVil'}>
                    ...
                    <tr>
                    <Link className='link tooo too' to={'/qulay-muhit/bolalar/hududd/toshSh'}>
                    ...
                    <tr>
                    <Link className='link tooo too' to={'/qulay-muhit/bolalar/hududd/qora'}>
