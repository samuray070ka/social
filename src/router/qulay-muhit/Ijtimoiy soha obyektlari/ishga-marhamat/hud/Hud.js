            ...
            <div className='big_box'>
                ...
                <tr>
                   ...
                   <Link to={'/qulay-muhit/ayollar/hud'} className='link tooo'>
                    ...
                    <tr>
                        <Link className='link tooo' to={'/qulay-muhit/ishga-marhamat'}>
                        <th className='one_th'>208 ta</th>
                        <div className='table_hr'></div>
                    ...
                    <tr>
                        ...
                        <tr>
                    <Link className='link too' to={'/qulay-muhit/ishga-marhamat/hud/anjann'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/ishga-marhamat/hud/namm'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/ishga-marhamat/hud/farr'}>
                        ...
                        <tr>
                    <Link className='link too' to={'/qulay-muhit/ishga-marhamat/hud/sirr'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/ishga-marhamat/hud/jizzz'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/ishga-marhamat/hud/samm'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/ishga-marhamat/hud/surr'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/ishga-marhamat/hud/qashsh'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/ishga-marhamat/hud/navoo'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/ishga-marhamat/hud/buxx'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/ishga-marhamat/hud/toshvilo'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/ishga-marhamat/hud/toshsh'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/ishga-marhamat/hud/xorr'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/ishga-marhamat/hud/qorr'}>
