        ...
        <div className='soha'>
            ...
            <div className='big_box'>
                <table className='table'>
                   ...
                   <tr>
                    <Link className='link tooo' to={'/qulay-muhit/saxovat'}>
                        <th className='one_th'>208 ta</th>
                        <div className='table_hr'></div>
                    ...
                    <tr>
                        ...
                        <tr>
                        <Link className='link too' to={'/qulay-muhit/saxovat/hudd/andi'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/saxovat/hudd/nama'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/saxovat/hudd/fargo'}>
                        ...
                        <tr>
                    <Link className='link too' to={'/qulay-muhit/saxovat/hudd/sird'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/saxovat/hudd/jizz'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/saxovat/hudd/sama'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/saxovat/hudd/surx'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/saxovat/hudd/qashqa'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/saxovat/hudd/navoi'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/saxovat/hudd/buxo'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/saxovat/hudd/toshViloy'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/saxovat/hudd/toSh'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/saxovat/hudd/xoraz'}>
                    ...
                    <tr>
                    <Link className='link too' to={'/qulay-muhit/saxovat/hudd/qoraq'}>
