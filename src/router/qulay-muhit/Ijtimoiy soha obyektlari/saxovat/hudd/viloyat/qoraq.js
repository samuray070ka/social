            ...
            <div className='big_box'>
                <table className='table'>
                   ...
                   <Link className='link tooo ' to={'/qulay-muhit/davlat/davlat'}>
                    ...
                    <tr>
                    <Link className='link tooo too' to={'/qulay-muhit/saxovat/hudd/jizz'}>
                    ...
                    <tr>
                    <Link className='link tooo too' to={'/qulay-muhit/saxovat/hudd/toshViloy'}>
                    ...
                    <tr>
                    <Link className='link tooo too' to={'/qulay-muhit/saxovat/hudd/toSh'}>
                    ...
                    <tr>
                    <Link className='link tooo too' to={'/qulay-muhit/saxovat/hudd/xoraz'}>
