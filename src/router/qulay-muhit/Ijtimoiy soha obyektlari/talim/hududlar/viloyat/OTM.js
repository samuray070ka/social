            ...
            <div className='big_box'>
                <table className='table'>
                   ...
                   <Link className='link tooo' to={'/qulay-muhit/talim/hududlar'}> 
                    ...
                    <tr>
                        <div>
                        <Link className='link too' to={'/qulay-muhit/talim/hududlar/mmt'}>
                        <th className='one_th'>208 ta</th>
                        <div className='table_hr'></div>
                        <td className='r'>MMT</td>
                        </Link>
                        </div>
                        </tr>
                        ...
                        <tr>
                        <div>
                        <Link className='link too' to={'/qulay-muhit/talim/hududlar'}>
                        <th className='one_th'>208 ta</th>
                        <div className='table_hr'></div>
                        <td className='r'>OTM</td>
                        </Link>
                        </div>
                        </tr>
                        <tr>
                    <Link className='link too e' to={'/qulay-muhit/talim/hududlar'}>
                    ...
                    <tr>
                        ...
                        <tr>
                        <div>
                        <Link className='link too' to={'/qulay-muhit/talim/hududlar/maktab'}>
                        <th className=' one_th'>208 ta</th>
                        <div className='table_hr'></div>
                        <td className='r'>Maktab</td>
                        </Link>
                        </div>
                        </tr>
