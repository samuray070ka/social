    ...
    <div>
        ...
        <div className='soha'>
            ...
            <div className='saha_biig'>
                <Link to={'/voyaga/yetim'} className='link'>
                ...
                <Link className='link' to={'/voyaga/alohida'}>
                <div className='biig_flex'>
                ...
                <Link className='link' to={'/voyaga/nazoratsiz'}>
            ...
            <div className='big_box'>
                <table className='table'>
                    <tr>
                    <Link className='link tooo' to={'/voyaga/yetim/hududlar'}>
                        <th className='one_th'>3 ta</th>
                    ...
                    <Link className='link  tooo' to={'/voyaga/bolalar/hududlar'}>
                        ...
                        <tr>
                        <Link className='link tooo' to={'/voyaga/yetim-1/hududlar'}>
                    ...
                    <tr>
                    <Link className='link tooo' to={'/voyaga/yetim-2/hududlar'}>
                        <th className='one_th'>0 ta</th>
                        <div className='table_hr'></div>
                    ...
                    <tr>
                   <Link className='link tooo' to={'/voyaga/yetim-3/hududlar'}> 
                        <th className='one_th'>0 ta</th>
                        <div className='table_hr'></div>
                        <td  className='one_td'>TYetim va ota-ona qarmogʻidan mahrum boʻlgan bolalarni patronatga (oilaga tarbiyaga) olish </td>
                   </Link>
                    </tr>
